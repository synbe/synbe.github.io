...
![img](./assets/41_a02_1a_anterolateral_approach.png)

打开髂胫束前部的深筋膜。

![img](./assets/41_a02_2a_anterolateral_approach.png)
...
![img](./assets/41_a02_2b_anterolateral_approach.png)

为了暴露关节，在半月板深缘和胫骨之间做一个水平的关节囊切开。在闭合时，半月板和关节囊的重新附着是强制性的。

![img](./assets/41_a02_3a_anterolateral_approach.png)
...
![img](./assets/41_a04_1a_posteromedial_approach.png)

临床图片显示后内侧入路的皮肤切口。

![img](./assets/41_a04_1a1_posteromedial_approach.png)

打开筋膜后，识别并暴露腘肌腱群。

![img](./assets/41_a04_2a_posteromedial_approach.png)

**接近胫骨平台内侧边缘**

将腘肌腱群向前牵开，腓肠肌向后和向下牵开。识别胫骨平台的内侧边缘。

![img](./assets/41_a04_2b2_posteromedial_approach.png)

**打开膝关节**

识别半月板，并在半月板与胫骨平台边缘之间切开关节囊，从而进入膝关节。

![img](./assets/41_a04_2c2_posteromedial_approach.png)

通过皮下解剖向前，可以暴露胫骨近端的前内侧部分（内侧柱）。在处理这部分的骨折时，可以将腘肌腱群向后牵开。

临床图片显示内侧平台和内侧半月板，腘肌腱群和远端的腓肠肌。

![img](./assets/41_a04_3_posteromedial_approach.png)
...
![img](./assets/41_a05_i100_posterior_approach.png)

患者俯卧位，在腘窝做一个懒S形皮肤切口。

切口应从关节线向上下延伸约8厘米。

![img](./assets/41_a05_i300_posterior_approach.png)

打开小腿筋膜。识别并保留小隐静脉和内侧腓肠神经。

![img](./assets/41_a05_i001_posterior_approach.png)

识别半膜肌并将其向内牵开。腓肠肌内侧头的附着点变得可见。

![img](./assets/41_a05_i002_posterior_approach.png)

识别腓肠肌的前缘并靠近其附着点切断，将释放的肌肉向外侧牵开。肌肉将保护重要的神经血管束。

后内侧关节囊进入视野。必要时可以切开以暴露骨折线。

![img](./assets/41_a05_i003_posterior_approach.png)
...
![img](./assets/41_a06_i400_mio_approach.png)

_AO教学视频：MIO胫骨，近端_

识别Gerdy结节。从Gerdy结节后部开始做一个大约5厘米长的直切口，并向远端和前部延伸。

![img](./assets/41_a06_1a_mio_approach.png)

![img](./assets/41_a06_i200_mio_approach.png)

从Gerdy结节开始打开深筋膜，并向下延伸。通过释放胫前肌的前附着点暴露骨头。

![img](./assets/41_a06_i300_mio_approach.png)
...
![img](./assets/41_a01_i0a_safe_zones.png)

**腘动脉**

腘动脉穿过腘窝中心。它在近端胫骨骨干水平分为胫前动脉，该动脉进入前室，仅在肌间隔膜上方，腓动脉或腓深动脉，以及胫后动脉。

![img](./assets/41_a01_i0b_safe_zones.png)
...
![img](./assets/41_e30_i16_bridging_exfix.png)
...
![img](./assets/41_a50_i220.png)

识别位于髌腱旁边的内侧软点，并在关节镜控制下进行触诊。

![img](./assets/41_a50_i240.png)

做一个5毫米的刺戳切口，插入关节镜钩。

可以通过内侧入口使用小型复位工具，复位胫骨棘撕脱。

![img](./assets/41_a50_i260.png)

如果需要，做一个小刺戳切口，以便从内侧髌周向近端胫骨逆行引入拉力螺钉。

![img](./assets/41_a50_i280.png)

取出关节镜后，通过关节镜轴插入吸引引流管。

以常规方式用缝合线关闭皮肤切口。

![img](./assets/41_a50_i300.png)