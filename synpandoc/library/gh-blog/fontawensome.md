...
尽管是为<a href="http://getbootstrap.com">Bootstrap</a>设计，但Font Awesome同样能与其它框架完美协同运作。
</div>
<div class="col-md-4 col-sm-6">
...
链接:
[Cheatsheet  The complete Font Awesome 4.7.0 icon reference  ](http://fontawesome.io/cheatsheet/)
...
温馨提示:
动画图标会在一些平台的浏览器中出现抖动的效果，可参见 问题列表#671 中的例子来解决此问题。
